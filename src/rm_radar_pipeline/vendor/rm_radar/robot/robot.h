...
class Robot {
   public:
    ...
    inline std::optional<int> track_id() const noexcept { return track_id_; }
    ...
    inline std::optional<cv::Point3f> velocity() const noexcept {
        return velocity_;
    }
   ...
   private:
    ...
    std::optional<int> track_id_ = std::nullopt;
    std::optional<cv::Point3f> location_ = std::nullopt;
    std::optional<cv::Point3f> velocity_ = std::nullopt;
